...
import {generateSaloon as _generateSaloon,drawSaloon as _drawSaloon,drawSaloonBuilding as _drawSaloonBuilding,buildSaloonInteriorV2 as _buildSaloonInterior,buildSaloonColliders as _buildSaloonColliders} from './bar/index.js';
...
export class WorldObjects{
  ...
  draw(gl,loc){
    ...
    // v51: saloon building (walls + roof + bat-wing doors + false front) is
    // drawn entirely by drawSaloonBuilding (in bar/saloon.js), NOT by
    // bldWithDoor. The interior is baked via buildSaloonInterior.
